...
import com.app.growfinance.databinding.FragmentEditTransactionBinding
...
class EditTransactionFragment : Fragment() {
    ...
    private fun updateTransaction(originalTransaction: com.app.growfinance.model.Transaction) {
        binding.apply {
